            ...
            <div>
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <textarea className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2" rows="4" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                </div>
              </form>
            </div>
              ...
              <div className="border border-gray-300 p-4 rounded-md">
                <table className="w-full mb-4">
                  <thead>
                    <tr>
                      ...
                      <th className="text-right text-sm font-medium text-gray-700">Total</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="text-sm text-gray-700">Satin gown × 1</td>
                      <td className="text-right text-sm text-gray-700">£69.99</td>
                    </tr>
                    <tr>
                      <td className="text-sm text-gray-700">Printed cotton t-shirt × 1</td>
                      <td className="text-right text-sm text-gray-700">£20.00</td>
                    </tr>
                    <tr>
                      <td className="text-sm text-gray-700 font-medium">Subtotal</td>
                      <td className="text-right text-sm text-gray-700">£89.99</td>
                    </tr>
                    <tr>
                      <td className="text-sm text-gray-700 font-medium">Shipping</td>
                      <td className="text-right text-sm text-gray-700">Flat rate: £2.00</td>
                    </tr>
                    <tr>
                      <td className="text-sm text-gray-700 font-medium">Total</td>
                      <td className="text-right text-sm text-gray-700">£91.99</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <label htmlFor="bank" className="ml-2 text-sm text-gray-700 font-medium">
