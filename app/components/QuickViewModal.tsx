...
const QuickViewModal = ({ isOpen, onClose }: QuickViewModalProps) => {
  ...
  return (
    ...
    >
      <div
        className={`w-[75%] max-h-[95%] overflow-auto modal-dialog modal-dialog-centered bg-white rounded-lg shadow-lg transform transition-transform duration-300 ${
      ...
      >
        <div className="modal-content ">
          <div className="modal-body p-8 relative">
            <button
              type="button"
              className="text-gray-600 absolute top-2 left-2"
              onClick={onClose}
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="product-details-content">
                <h5 className="text-sm font-semibold text-[16px]">
                  Premium collection
                </h5>
                <h3 className="text-[40px] mt-2">
                ...
                <div className="flex justify-start my-5">
                  <div className="flex space-x-2 border-[2px] border-[#de6565] items-center py-2 px-1 rounded-[50px]">
                    ...
                    <button
                      ...
                      className="flex items-center px-3 py-1 cursor-pointer border-l"
                ...
                <div className="flex items-center justify-start space-x-6">
                  ...
                  <button
                    type="button"
                    className="bg-[#de6565] text-white px-4 py-2 rounded-[50px] hover:bg-[#364958]"
                  >
                    Add to cart
                  </button>
                </div>
