...
const Header = () => {
  ...
  return (
    ...
    >
          ...
          <div className="relative group">
            ...
            <ul className="absolute hidden group-hover:flex bg-white shadow-lg -mt-3">
              <table className="w-[500px] table-fixed">
                <thead>
                  <tr>
                    <th className="text-center py-4 text-gray-700 font-bold border-r">Page</th>
                    <th className="text-center py-4 text-gray-700 font-bold">Order Page</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t">
                    <td className="text-center border-b border-gray-200 p-4 hover:bg-gray-200 border-r">
                      <Link href="/account" className="text-gray-700 hover:text-[#ff6565]">My account</Link>
                    </td>
                  ...
                  <tr className="">
                    <td className="text-center border-b border-gray-200 p-4 hover:bg-gray-200 border-r">
                      <Link href="/cart" className="text-gray-700 hover:text-[#ff6565]">Cart</Link>
                    </td>
                    <td className="text-center border-b border-gray-200 p-4 hover:bg-gray-200">
                  ...
                  <tr className="">
                    <td className="text-center p-4 hover:bg-gray-200 border-r">
                      <Link href="/checkout" className="text-gray-700 hover:text-[#ff6565] ">Checkout</Link>
                    </td>
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed inset-0 z-40 h-screen bg-black transition-opacity duration-300 ${isMobileMenuOpen ? 'opacity-80' : 'opacity-0 pointer-events-none'}`}
