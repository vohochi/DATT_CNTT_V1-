    ...
    return (
        <>
            ...
            >
                ...
                <div>
                    <h2 className="flex items-center justify-between text-xl font-semibold px-8 py-4 bg-[#ff6565] hover:bg-gray-800" onClick={onClose}>
                        Shopping Cart
                        ...
                        <ul className="aside-cart-product-list">
                            <li className="aside-product-list-item flex justify-between items-start mb-6 ">
                                <div className="flex items-start">
                                    <Link href="/detail" className="border border-gray-300 p-1 rounded-[4px]">
                                        <Image
                                    ...
                                    <div className="flex flex-col ml-4">
                                        <Link href="/detail">
                                            <span className="product-title hover:text-[#ff6565] pb-2">Leather Mens Slipper</span>
                                        </Link>
                                        <span className="product-price text-gray-600">1 × £69.99</span>
                                    </div>
                                </div>
                                <button className="text-[21px] remove hover:text-red-800 transition duration-200 ease-in-out">×</button>
                            </li>
