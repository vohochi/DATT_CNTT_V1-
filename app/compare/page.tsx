...
const Compare = () => {
  ...
  const productAttributes = [
    ...
    { label: 'Price', render: (product: any) => `£${product.price}` },
    { label: 'Sku', render: (product: any) => product.sku },
    { label: 'Description', render: (product: any) => product.description },
    {
      label: 'Availability',
      render: (product: any) => (
    ...
    { label: 'Weight', render: (product: any) => product.weight },
    { label: 'Dimensions', render: (product: any) => product.dimensions },
  ];
                ...
                {productAttributes.map((attr, attrIndex) => (
                  <tr key={attrIndex} className="border-b">
                    ...
                    {arrTest.map((product, index) => (
                      <td key={index} className="px-4 py-4 text-center border min-w-[250px]">
                        {attr.render(product)}
                      </td>
                    ))}
                  </tr>
