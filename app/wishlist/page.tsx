  ...
  return (
    <main className="main-content">
      ...
      <section className="section-space py-8">
        <div className="container mx-auto w-full sm:w-[90%] lg:w-[77%] my-[50px] lg:my-[100px]">
          <div className="overflow-x-auto">
            <form action="#" method="post">
              <table className="table-auto min-w-[640px] w-full text-center border-collapse">
                ...
                <tbody className="border">
                  {arrTest.map((item, index) => (
                    <tr
                      key={index}
                      className="border-b hover:bg-[#00000006] transition-all duration-200 ease-in-out"
                    >
                      <td className="product-remove border-r p-4 text-bold hover:text-[#ff6565]">
                        x
                      </td>
                        ...
                        <div className="thumb">
                          <Link href="/single-product">
                            <Image
                              ...
                              className="object-contain min-w-[60px]"
                            />
                          </Link>
                        </div>
                      </td>
                      <td className="product-name border-r p-4">
                        <a
                          className="title hover:text-[#ff6565]"
                          href="/single-product"
                        >
                          {item.name}
                        </a>
                      ...
                      <td className="product-stock-status border-r p-4">
                        <span className="wishlist-in-stock text-[#ff6565]">
                          {item.stockStatus}
                        </span>
                      </td>
                      <td className="product-add-to-cart p-4">
                        <Button className="btn-shop-cart border border-gray-300 p-2 lg:p-5 rounded transition-colors duration-300 ease-in-out hover:bg-red-500 hover:text-white hover:border-red-500">
