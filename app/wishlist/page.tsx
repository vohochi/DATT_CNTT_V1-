                                    ...
                                    {arrTest.map((item, index) => (
                                        <tr key={index} className="border-b hover:bg-[#00000006] transition-all duration-200 ease-in-out">
                                            ...
                                            <td className="product-name border-r p-4">
                                                <a className="title hover:text-[#ff6565]" href="/single-product">{item.name}</a>
                                            </td>
                                            ...
                                            <td className="product-add-to-cart p-4">
                                                <Button
                                                    className="btn-shop-cart border border-gray-300 p-2 lg:p-5 rounded transition-colors duration-300 ease-in-out hover:bg-red-500 hover:text-white hover:border-red-500"
                                                >
